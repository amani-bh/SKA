...
import { getQuestionsBySearch } from '../../../utils/Forum';
...
export default function SearchResults() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await getQuestionsBySearch(query);
      setQuestions(result);
                    ...
                    <div className="col-sm-7">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Docy WordPress Theme</li>
                            </ol>
                        </nav>
                    </div>
                    <div className="col-sm-5">
                        <a href="#" className="date"><i className="icon_clock_alt"></i>Updated on March 03, 2020</a>
                    </div>
                </div>
            </div>
        </section>
                                        ...
                                        {questions?.map(question=>(
                                             ...
                                             <div className="media">
                                                 ...
                                                 <div className="media-body">
                                                     ...
                                                     <h6><i className="icon_clock_alt"></i> {moment(question?.created_at).fromNow()}
                                                     </h6>
                                                 </div>
                                                 <div className="media-right">
                                                    
                                                     <Link className="count" to={"/user_profile/" + question?.author_id}><IonIcon name="person-circle-outline"/> {question?.author_name}</Link>
